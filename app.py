...
# ✅ ИСПРАВЛЕНО: стековые декораторы вместо Command() | F.text
@dp.message(Command("help"))
@dp.message(F.text.lower().in_({"помощь", "команды", "меню"}))
...
@dp.message(F.text.lower().in_({"профиль", "мой профиль", "стата"}))
...
# ✅ ИСПРАВЛЕНО: стековые декораторы вместо Command() | F.text
@dp.message(Command("biz"))
@dp.message(F.text.lower().in_({"бизнес", "биз"}))
...
@dp.message(F.text.lower().in_({"карта", "карту", "крутить"}))
...
@dp.message(F.text.lower().startswith("клан"))
...
@dp.message(F.text.lower().in_({"магазин", "шоп", "маркет"}))
...
@dp.message(F.text.lower().in_({"дуэль"}))
