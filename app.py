...
# ✅ ИСПРАВЛЕНО: декоратор и функция вынесены из тела add_exp
...
# ✅ ИСПРАВЛЕНО: декоратор вынесен из тела profile_cmd
...
# ✅ ИСПРАВЛЕНО: декоратор вынесен из тела biz_cb
...
# ✅ ИСПРАВЛЕНО: функция вынесена из тела buy_cb
